...
test.describe('FAQ Functionality Tests', () => {
    ...
    test.describe.skip('FAQ Admin Configuration Tests', () => {
        ...
        test.skip('TC1.2: Set FAQ Link with Valid URL', async ({ page, loginPage, faqPage }) => {
        ...
        test.skip('TC1.4: Set FAQ Link with Empty Value', async ({ page, loginPage, faqPage }) => {
            await page.goto(`${baseURL}/logged-out/login/email`);
            await loginPage.loginUser(adminEmail, adminPassword);
            await page.waitForLoadState('domcontentloaded');
        ...
        test.skip('TC1.5: Set FAQ Link with Invalid URL Format', async ({ page, loginPage, faqPage }) => {
            await page.goto(`${baseURL}/logged-out/login/email`);
            await loginPage.loginUser(adminEmail, adminPassword);
            await page.waitForLoadState('domcontentloaded');
    ...
    test.describe.skip('FAQ Navigation Tests (Logged In Users)', () => {
    ...
    test.describe.skip('FAQ Link Update Propagation Tests', () => {
        ...
        test.skip('TC4.2: FAQ Link Updates Reflect Immediately (Logged Out)', async ({ page, loginPage, faqPage, context }) => {
            // Admin updates FAQ link
            await page.goto(`${baseURL}/logged-out/login/email`);
            await loginPage.loginUser(adminEmail, adminPassword);
            await page.waitForLoadState('domcontentloaded');
    ...
    test.describe('Edge Cases and Error Handling', () => {
        ...
        test.skip('TC5.4: FAQ Link with HTTPS Protocol', async ({ page, loginPage, faqPage }) => {
            await page.goto(`${baseURL}/logged-out/login/email`);
            await loginPage.loginUser(adminEmail, adminPassword);
            await page.waitForLoadState('domcontentloaded');
        ...
        test.skip('TC5.5: FAQ Link with HTTP Protocol', async ({ page, loginPage, faqPage }) => {
            await page.goto(`${baseURL}/logged-out/login/email`);
            await loginPage.loginUser(adminEmail, adminPassword);
            await page.waitForLoadState('domcontentloaded');
    ...
    test.describe('Permission and Security Tests', () => {
        ...
        test.skip('TC6.2: XSS Prevention in FAQ Link', async ({ page, loginPage, faqPage }) => {
            await page.goto(`${baseURL}/logged-out/login/email`);
            await loginPage.loginUser(adminEmail, adminPassword);
            await page.waitForLoadState('domcontentloaded');
    ...
    test.describe('UI/UX Tests', () => {
        ...
        test.skip('TC7.3: FAQ Settings Page Layout', async ({ page, loginPage, faqPage }) => {
            await page.goto(`${baseURL}/logged-out/login/email`);
            await loginPage.loginUser(adminEmail, adminPassword);
            await page.waitForLoadState('domcontentloaded');
    ...
    test.describe('Mobile Responsiveness Tests', () => {
        ...
        test.skip('TC8.3: FAQ Settings Page on Mobile', async ({ page, loginPage, faqPage }) => {
            // Set mobile viewport
            await page.setViewportSize({ width: 375, height: 667 });
