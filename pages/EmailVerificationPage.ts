...
export class EmailVerificationPage {
  ...
  async changePassword(newPassword: string): Promise<void> {
    ...
    await this.page.getByRole('textbox', { name: 'new password', exact: true }).fill('#TransferTri1')
    await this.page.getByRole('textbox', { name: 'confirm new password' }).fill('#TransferTri1')
